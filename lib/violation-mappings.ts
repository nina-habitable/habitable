...
export const VIOLATION_MAPPINGS: ViolationMapping[] = [
  ...
  {
    id: "co-notice",
    keywords: ["CARBON MONOXIDE", "POST", "NOTICE"],
    title: "Missing carbon monoxide detector notice",
    explanation: "The required notice about carbon monoxide detector requirements is not posted.",
    icon: "📋",
    severity: "low",
  },
  {
    id: "co-detector-issue",
    keywords: ["CARBON MONOXIDE", "REPLACE"],
    title: "Carbon monoxide detector issue",
    explanation: "A carbon monoxide detector is missing, defective, or needs replacement. CO detectors are critical life safety devices.",
    icon: "🚨",
    severity: "critical",
  },
  {
  ...
  // ═══════════════════════════════════════════
  // ADDITIONAL PATTERNS (38-50)
  // ═══════════════════════════════════════════

  {
    id: "failed-registration",
    keywords: ["REGISTRATION STATEMENT"],
    title: "Failed building registration",
    explanation: "The landlord failed to file a required registration statement with HPD. This is a legal requirement for all rental buildings.",
    icon: "📋",
    severity: "low",
  },
  {
    id: "failed-bedbug-filing",
    keywords: ["BEDBUG REPORT"],
    title: "Failed to file bed bug report",
    explanation: "The landlord did not file the required annual bed bug report with HPD.",
    icon: "📋",
    severity: "low",
  },
  {
    id: "missing-reg-sign",
    keywords: ["REGISTRATION NUMBER", "POST"],
    title: "Missing building registration sign",
    explanation: "The building's HPD registration number is not posted in the entrance as required.",
    icon: "📋",
    severity: "low",
  },
  {
    id: "missing-tenant-rights",
    keywords: ["HOUSING INFORMATION GUIDE"],
    title: "Missing tenant rights notice",
    explanation: "The required notice about tenant rights and HPD's housing information guide is not posted.",
    icon: "📋",
    severity: "low",
  },
  {
    id: "trash-rubbish",
    keywords: ["RUBBISH"],
    title: "Trash/waste disposal issue",
    explanation: "The building lacks proper trash receptacles or waste collection arrangements.",
    icon: "🗑️",
    severity: "medium",
  },
  {
    id: "trash-waste",
    keywords: ["WASTE MATERIAL"],
    title: "Trash/waste disposal issue",
    explanation: "The building lacks proper trash receptacles or waste collection arrangements.",
    icon: "🗑️",
    severity: "medium",
  ...
  {
    id: "blocked-heating-access",
    keywords: ["READY ACCESS", "HEATING SYSTEM"],
    title: "Blocked access to heating system",
    explanation: "Access to the building's boiler or heating system is blocked or locked, preventing inspection and emergency repairs.",
    icon: "🔥",
    severity: "high",
  },
  {
    id: "gas-leak-notice",
    keywords: ["GAS LEAK", "NOTICE"],
    title: "Missing gas leak safety notice",
    explanation: "The required notice about gas leak procedures is not posted in the building.",
    icon: "📋",
    severity: "medium",
  },
  {
    id: "inspection-certificate",
    keywords: ["CERTIFICATE OF INSPECTION"],
    title: "Missing inspection certificate",
    explanation: "The required certificate of inspection visits is not posted near the mailboxes.",
    icon: "📋",
    severity: "low",
  },
  {
    id: "self-closing-door",
    keywords: ["SELF-CLOSING DOOR"],
    title: "Broken fire safety door",
    explanation: "A self-closing door required for fire safety is missing or defective.",
    icon: "🔒",
    severity: "medium",
  },
  {
    id: "broken-toilet",
    keywords: ["FLUSHING APPARATUS"],
    title: "Broken toilet",
    explanation: "A toilet is not flushing properly and needs repair.",
    icon: "🔧",
    severity: "medium",
  },
  {
  ...
  {
    id: "aep-notice",
    keywords: ["ALTERNATIVE ENFORCEMENT PROGRAM", "POST"],
    title: "Missing AEP notice",
    explanation: "This building is in HPD's worst-offender program and is required to post a notice with owner contact information.",
    icon: "📋",
    severity: "low",
  },
